...
W = tf.Variable(np.float32(np.random.rand(4, 16))*0.1)
b = tf.Variable(np.float32(np.random.rand(16))*0.1)
x2 = tf.nn.softmax((tf.sigmoid(tf.matmul(x, W) + b)))

W2 = tf.Variable(np.float32(np.random.rand(16, 3))*0.1)
b2 = tf.Variable(np.float32(np.random.rand(3))*0.1)

y = tf.nn.softmax((tf.sigmoid(tf.matmul(x2, W2) + b2)))
